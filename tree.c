// Phase 2: write_tree_level recursively builds tree objects.
// Groups index entries by subdirectory prefix using strchr('/').// tree.c — Tree object serialization and construction
//
